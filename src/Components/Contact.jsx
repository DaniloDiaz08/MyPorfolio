        ...
        <div className='w-full mt-20 bg-[#424242] flex justify-center p-4'>
            <form method='POST' action="https://getform.io/f/e21fd801-7d89-4e94-84bc-883ac052e658" className='flex flex-col max-w-[600px] w-full'>
                <div className='pb-8'>
                    ...
                    <p className='text-gray-300 py-4'>|| Sumit the form below or shoot me an email - diazdanilo340@gmail.com</p>
                </div>
               ...
               <div className='flex justify-center mt-4'>
                    <button href="#_" class="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-[#44cde3] transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-[#424242] group">
